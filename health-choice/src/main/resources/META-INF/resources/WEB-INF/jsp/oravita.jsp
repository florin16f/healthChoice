    ...
    <body>
        ...
        <div class="section">
	    	<div class="container">
				<div class="row">
				<div class="col-sm-4">
				<img class="img-responsive" src="img/oravita.png">
				</div>
				<div class="col-sm-8">
       ...
       <iframe width="500" height="300" src="https://www.youtube.com/embed/Id3aeduuot8" frameborder="0" allowfullscreen></iframe>
