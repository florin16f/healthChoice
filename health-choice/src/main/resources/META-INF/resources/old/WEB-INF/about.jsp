...
<div id="content">
  <div class="container_12 bot-1">
    ...
    <div class="grid_6"> <span class="lead">In pede mi aliquet sit amet euismod in auctor ut ligula</span><br>
    ...
    <div class="grid_3"> <img src="images/page2-img1.jpg" alt=""> </div>
  ...
  <div class="bg-3 bot-1">
    <div class="container_12">
      ...
      <div class="grid_6"> Consectetuer adipiglest lacenean nummy nrerit uris. Pha sellortsce scipit varius mi. Cum sociistoque pentibus et magnis diarturintots nascetur ricu. Gyrolutko moiliktwe
        ...
        <div class="lists">
          <div> <strong class="text-info">Consectetuer adipigl</strong>
            <ul class="list">
